...
$(document).ready(function() {
	...
	ymaps.ready(function () {
		...
		if ($("#contactsMap").length) {
			...
			var desktopCenter = [55.769170, 37.565967],
					mobileCenter = [55.769170, 37.567967];

			if ($("#sm-indicator").css("display") == "block") {

				curCenter = mobileCenter;

			} else {

				curCenter = desktopCenter;
			...
			var myMap = new ymaps.Map('contactsMap', {
				...
				myPlacemark = new ymaps.Placemark([55.769170, 37.567967], {
					hintContent: '',
					balloonContent: ''
				}, {
					// Опции.
	...
	$("body").on("click", function (e) {
		...
		if ($("#sm-indicator").css("display") == "block" && $("#mobile-indicator").css("display") != "block") {
